!function() {
	...
	function s(o, s, f) {
		function g() {
			...
			$f(o) ? ($f(o).getParent().innerHTML = "", w = $f(o).getIndex(), p[w] = S) : (p.push(S), w = p.length - 1), E = parseInt(o.style.height, 10) || o.clientHeight, y = o.id || "fp" + l(), m = s.id || y + "_api", s.id = m, f.playerId = y, "string" == typeof f && (f = {
				...
				url : f.clip
			}), f.clip = f.clip || {}, o.getAttribute("href", 2) && !f.clip.url && (f.clip.url = o.getAttribute("href", 2)), v = new c(f.clip, -1, S), f.playlist = f.playlist || [ f.clip ];var r = 0;
			n(f.playlist, function() {
				...
				"function" == typeof t && (v[e] ? v[e](t) : u(x, e, t),
				delete f[e]
				)
	...
	function n(e) {
		switch (r(e)) {
		case "string":
			return e = e.replace(new RegExp('(["\\\\])', "g"), "\\$1"), e = e.replace(/^\s?(\d+)%/, "$1pct"), '"' + e + '"';case "array":
	...
	function r(e) {
		...
		for (u = 0; u < o.length; u++) {
			var l = o[u],
				s = !0;
			if (l.canPlayType)
				if (l.src) n(l, a(e, l.src)) && (s = !1);else
