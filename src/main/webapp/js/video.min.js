!function(t, e) {
	...
	function V(t, e) {
		...
		delete n.handlers[e]
		, t.removeEventListener ? t.removeEventListener(e, n.dispatcher, !1) : t.detachEvent && t.detachEvent("on" + e, n.dispatcher)), Object.getOwnPropertyNames(n.handlers).length <= 0 && (
		delete n.handlers
		,
		delete n.dispatcher
		,
	...
	function vt(t) {
		...
		var o = !1,
			...
			a = t.xhr || null;
		a || (a = t.cors || t.useXDR ? new ft.XDomainRequest : new ft.XMLHttpRequest);var l,
			c,
			u,
			h = a.url = t.uri || t.url,
	...
	function Ct(t, e, n) {
		function r() {
			var e = _t(t);
			if (null === e)
				throw new mt(mt.Errors.BadTimeStamp, "Malformed timestamp: " + o);
		...
		if (i(), e.startTime = r(), i(), "--\x3e" !== t.substr(0, 3))
			throw new mt(mt.Errors.BadTimeStamp, "Malformed time stamp (time stamps must be separated by '--\x3e'): " + o);
	...
	function kt(t, e) {
		...
		for (var r, i = t.document.createElement("div"), o = i, s = []; null !== (r = function() {
			...
			if ("<" !== r[0]) o.appendChild(t.document.createTextNode(function(t) {
				...
				if ("/" === r[1]) {
					s.length && s[s.length - 1] === r.substr(2).replace(">", "") && (s.pop(), o = o.parentNode);continue
				}
				var a,
					l = _t(r.substr(1, r.length - 2));
				if (l) {
					a = t.document.createProcessingInstruction("timestamp", l), o.appendChild(a);continue
				}
	...
	function jt(t, e, n) {
		var r = /MSIE\s8\.0/.test(navigator.userAgent),
			...
			o = "rgba(0, 0, 0, 0.8)";
		r && (i = "rgb(255, 255, 255)", o = "rgb(0, 0, 0)"), xt.call(this), this.cue = e, this.cueDiv = kt(t, e.text);var s = {
			color : i,
			backgroundColor : o,
			position : "relative",
			left : 0,
		...
		r || (s.writingMode = "" === e.vertical ? "horizontal-tb" : "lr" === e.vertical ? "vertical-lr" : "vertical-rl", s.unicodeBidi = "plaintext"), this.applyStyles(s, this.cueDiv), this.div = t.document.createElement("div"), s = {
			...
			whiteSpace : "pre-line",
			position : "absolute"
		}, r || (s.direction = Et(this.cueDiv), s.writingMode = "" === e.vertical ? "horizontal-tb" : "lr" === e.vertical ? "vertical-lr" : "vertical-rl".stylesunicodeBidi = "plaintext"), this.applyStyles(s), this.div.appendChild(this.cueDiv);var a = 0;
	...
	function Dt(t, e, n) {
		var r = this,
			...
			o = {};
		i ? r = document.createElement("custom") : o.enumerable = !0, r.hasBeenReset = !1;var s = "",
			a = !1,
			l = t,
			c = e,
			u = n,
	...
	function Ft(t, e, n, r) {
		var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {},
			o = t.textTracks();
		i.kind = e, n && (i.label = n), r && (i.language = r), i.tech = t;var s = new Tr.text.TrackClass(i);
	...
	function qt() {
		...
		if ("string" == typeof a) qt(t, Rr[a], n, i, o, s);
			...
			l.length ? qt(t, l, n, i, o, s) : s ? n(t, o) : qt(t, Rr["*"], n, i, o, !0)
	}
	function Kt(t, e) {
	...
	function Gt(t) {
		...
		t = t < 0 ? 0 : t;var n = Math.floor(t % 60),
					...
					if ("string" == typeof t && (t = this.getChild(t)), t && this.children_) {
						for (var e = !1, n = this.children_.length - 1; n >= 0; n--)
							if (this.children_[n] === t) {
								e = !0, this.children_.splice(n, 1);break
						}
						if (e) {
	...
	var jn = ot,
		...
		In = function(t) {
			function e(n, r) {
				Ie(this, e);var i = Le(this, t.call(this, n, r));
	...
	var Dn = function(t) {
		function e() {
			...
			Ie(this, e);var o = Le(this, t.call(this));
			if (!i && (i = o, Se)) {
		...
		return De(e, t), e.prototype.addTrack = function(t) {
				...
				for (var e = void 0, n = 0, r = this.length; n < r; n++)
					if (this[n] === t) {
						e = this[n], e.off && e.off(), this.tracks_.splice(n, 1);break
				}
				e && this.trigger({
					track : e,
					type : "removetrack"
	...
	var Rn = function(t, e) {
			...
			return t.prototype.addTrackElement_ = function(t) {
					...
					for (var e = void 0, n = 0, r = this.trackElements_.length; n < r; n++)
						if (t === this.trackElements_[n].track) {
							e = this.trackElements_[n];break
					}
					return e
				}, t.prototype.removeTrackElement_ = function(t) {
					for (var e = 0, n = this.trackElements_.length; e < n; e++)
						if (t === this.trackElements_[e]) {
							this.trackElements_.splice(e, 1);break
					}
				}, t
		}(),
		Un = function() {
		...
		Yn = function(t) {
			function e() {
				var n,
					r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
				Ie(this, e);var i = Le(this, t.call(this)),
					o = i;
				if (Se) {
					o = ce.createElement("custom");
		...
		dr = function(t) {
			function e() {
				...
				var o = Q(i, {
					...
					a = o.default;
				"metadata" !== o.kind && "chapters" !== o.kind || (s = "hidden");var l = n = Le(this, t.call(this, o));
				if (l.tech_ = o.tech, Se)
					for (var c in e.prototype) "constructor" !== c && (l[c] = e.prototype[c]);
				l.cues_ = [], l.activeCues_ = [];var u = new Un(l.cues_),
				...
				return "disabled" !== s && l.tech_.ready(function() {
						...
						get : function() {
							...
							if (p = !1, e.length !== this.activeCues_.length)
								p = !0;else
			...
			return De(e, t), e.prototype.addCue = function(t) {
					...
					for (var e = this.cues_.length; e--;) {
						...
						if (n === t || n.originalCue_ && n.originalCue_ === t) {
							this.cues_.splice(e, 1), this.cues.setCues_(this.cues_);break
						}
					}
				}, e
		}(Yn);
	...
	var fr = function(t) {
		...
		mr = function(t) {
			function e() {
				...
				Ie(this, e);var r = Le(this, t.call(this)),
					i = void 0,
					o = r;
				if (Se) {
					o = ce.createElement("custom")
	...
	xt.prototype.applyStyles = function(t, e) {
		...
		switch (e) {
		case "+x":
			return this.left < t.left;case "-x":
			return this.right > t.right;case "+y":
			return this.top < t.top;case "-y":
			...
			t && (i.buffer += i.decoder.decode(t, {
				...
				for (var a = !1; i.buffer;) {
					...
					case "HEADER":
						...
						}(o) : o || (i.state = "ID");continue;case "NOTE":
						o || (i.state = "ID");continue;case "ID":
						if (/^NOTE($|[ \t])/.test(o)) {
							i.state = "NOTE";
							break
						}
					...
					case "CUE":
						try {
							...
							i.reportOrThrowError(t), i.cue = null, i.state = "BADCUE";continue
						} i.state = "CUETEXT";continue;case "CUETEXT":
						var l = -1 !== o.indexOf("--\x3e");
						if (!o || l && (a = !0)) {
							i.oncue && i.oncue(i.cue), i.cue = null, i.state = "ID";continue
						}
						i.cue.text && (i.cue.text += "\n"), i.cue.text += o;continue;case "BADCUE":
	...
	var Or = Dt,
		...
		Lr = function(t) {
			function e() {
				...
				Ie(this, e), n.reportTouchActivity = !1;var i = Le(this, t.call(this, null, n, r));
	...
	var Rr = {},
		...
		Hr = function(t) {
			function e(n, r, i) {
				...
				if (r.playerOptions.sources && 0 !== r.playerOptions.sources.length) n.src(r.playerOptions.sources);else
	...
	var zr = {
		...
		Xr = function(t) {
			function e(n, r, i) {
				Ie(this, e);var o = Le(this, t.call(this, n, r, i));
	...
	var di = function(t) {
		function e(n) {
			...
			Ie(this, e), r.vertical = r.vertical || !1, (void 0 === r.volumeBar || o(r.volumeBar)) && (r.volumeBar = r.volumeBar || {}, r.volumeBar.vertical = r.vertical);var i = Le(this, t.call(this, n, r));
	...
	var vi = function(t) {
		function e(n) {
			var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
			Ie(this, e), void 0 !== r.inline ? r.inline = r.inline : r.inline = !0, (void 0 === r.volumeControl || o(r.volumeControl)) && (r.volumeControl = r.volumeControl || {}, r.volumeControl.vertical = !r.inline);var i = Le(this, t.call(this, n, r));
	...
	var gi = function(t) {
		function e(n) {
			var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
			Ie(this, e);var i = Le(this, t.call(this, n, r));
			i.menuButton_ = new Kr(n, r), i.menuButton_.controlText(i.controlText_), i.menuButton_.el_.setAttribute("aria-haspopup", "true");var o = Kr.prototype.buildCSSClass();
	...
	var bi = function(t) {
		function e(n, r) {
			Ie(this, e);var i = r.track,
				o = n.textTracks();
			r.label = i.label || i.language || "Unknown", r.selected = "showing" === i.mode;var s = Le(this, t.call(this, n, r));
			s.track = i;var a = ln(s, s.handleTracksChange),
			...
			if (n.on([ "loadstart", "texttrackchange" ], a), o.addEventListener("change", a), o.addEventListener("selectedlanguagechange", l), s.on("dispose", function() {
				...
				s.on([ "tap", "click" ], function() {
					if ("object" !== Me(ie.Event)) try {
						...
						} catch (t) {} c || (c = ce.createEvent("Event"), c.initEvent("change", !0, !0)), o.dispatchEvent(c)
				})
			}
			return s
		}
	...
	var Ti = function(t) {
		function e(n, r) {
			Ie(this, e), r.track = {
				...
				default : !1,
				mode : "disabled"
			}, r.kinds || (r.kinds = [ r.kind ]), r.label ? r.track.label = r.label : r.track.label = r.kinds.join(" and ") + " off", r.selectable = !0;var i = Le(this, t.call(this, n, r));
	...
	var ki = function(t) {
		function e(n, r) {
			Ie(this, e);var i = r.track,
				o = r.cue,
				s = n.currentTime();
			r.selectable = !0, r.label = o.text, r.selected = o.startTime <= s && s < o.endTime;var a = Le(this, t.call(this, n, r));
	...
	var xi = function(t) {
		function e(n, r) {
			Ie(this, e), r.track = {
				...
				default : !1,
				mode : "disabled"
			}, r.selectable = !1, r.name = "CaptionSettingsMenuItem";var i = Le(this, t.call(this, n, r));
	...
	var Ni = function(t) {
		function e(n, r) {
			Ie(this, e);var i = r.track,
				o = n.audioTracks();
			r.label = i.label || i.language || "Unknown", r.selected = i.enabled;var s = Le(this, t.call(this, n, r));
			s.track = i;var a = ln(s, s.handleTracksChange);
	...
	var Mi = function(t) {
		function e(n, r) {
			Ie(this, e);var i = r.rate,
				o = parseFloat(i, 10);
			r.label = i, r.selected = 1 === o, r.selectable = !0;var s = Le(this, t.call(this, n, r));
	...
	var Ji = function(t) {
		function r(n, i) {
			Ie(this, r), i.temporary = !1;var o = Le(this, t.call(this, n, i));
					...
					if (!t || !this.options_.playerElIngest && !this.movingMediaElementInDOM) {
						if (t) {
							...
							var i = this.options_.tag && C(this.options_.tag),
								o = Q({}, i);
							Pe && !0 === this.options_.nativeControlsForTouch ||
							delete o.controls
							, T(t, r(o, {
		...
		so = function(t) {
			function e(n, i, o) {
					...
					if ("function" == typeof n.closest) {
						...
						for (var a = n; a && 1 === a.nodeType;) {
							if (C(a).hasOwnProperty("lang")) {
								i.language = a.getAttribute("lang");break
							}
							a = a.parentNode
				}
				...
				if (l.tag = n, l.tagAttributes = n && C(n), l.language(l.options_.language), i.languages) {
					...
					l.languages_ = e.prototype.options_.languages;
				...
				l.options_.playerOptions = u, l.middleware_ = [], l.initChildren(), l.isAudio("audio" === n.nodeName.toLowerCase()), l.controls() ? l.addClass("vjs-controls-enabled") : l.addClass("vjs-controls-disabled"), l.el_.setAttribute("role", "region"), l.isAudio() ? l.el_.setAttribute("aria-label", l.localize("Audio Player")) : l.el_.setAttribute("aria-label", l.localize("Video Player")), l.isAudio() && l.addClass("vjs-audio"), l.flexNotSupported_() && l.addClass("vjs-no-flex"), ye || l.addClass("vjs-workinghover"), e.players[l.id_] = l;var p = ee.split(".")[0];
	...
	var lo = {},
		...
		yo = function() {
			function t(e) {
				...
				this.player = e, Y(this),
				delete this.trigger
				, G(this, this.constructor.defaultState), ho(e, this.name), this.dispose = ln(this, this.dispose), e.on("dispose", this.dispose)
			}
			return t.prototype.getEventHash = function() {
					...
					if ("string" != typeof e)
						throw new Error('Illegal plugin name, "' + e + '", must be a string, was ' + (void 0 === e ? "undefined" : Me(e)) + ".");
					...
					if ("function" != typeof n)
						throw new Error('Illegal plugin for "' + e + '", must be a function, was ' + (void 0 === n ? "undefined" : Me(n)) + ".");
	...
	var go = function(t, e) {
			if ("function" != typeof e && null !== e)
				throw new TypeError("Super expression must either be null or a function, not " + (void 0 === e ? "undefined" : Me(e)));
			t.prototype = Object.create(e && e.prototype, {
				constructor : {
					value : t,
					enumerable : !1,
