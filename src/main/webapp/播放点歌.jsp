...
<%     
   ...
   List<String> songlist=PalyedServlet.getSonglist();  
...
out.println("<a href='video-play1.jsp?a="+song+"'  target='iframe_B'><img src='img/play.png' alt='' class='playico'></a> <a onclick='sublist(this)' id='aid"+i+"'><img src='img/add.png'  class='addico'></a></div></div>");
i++;
}
